...
function getPhotoLink(n, t) {
    var i = $(t).val();
    $("#photo_dl_" + n).attr("href", i)
}
...
function ksearchvideo() {
    ...
    return n && $.ajax({
        ...
        beforeSend: function() {
            ...
            $(".section-search").removeClass("bg-black");
        ...
        success: function(n, t, i) {
            ...
            n.status == "ok" ? (n.p === "search" ? renderListVideo(n.items) : n.p !== "convert" || n.mess ? n.p === "facebook" ? n.mess ? ($("#search-form").css("display", "block"),
            renderFail(n.mess)) : ($("#search-result").html(n.data),
            loadAddthis()) : n.mess && ($("#search-form").css("display", "block"),
            renderFail(n.mess)) : (k__token = n.token,
...
function loadAddthis() {
    typeof addthis != "undefined" && $.isFunction(addthis.layers.refresh) && addthis.layers.refresh()
}
...
function renderListVideo(n) {
    ...
    if (n.length) {
        ...
        t = 0; t < n.length; ++t)
            ...
            u = '<li> <a  href="' + r + '" title="' + item.t + '" target="_blank"><div class="img-thumb"><img src="https://i.ytimg.com/vi/' + item.v + '/mqdefault.jpg" width="100%" height="100%"  alt="youtube downloader"/><span class="time">' + item.d + '<\/span><\/div> <div class="content"><div class="clearfix"><h3>' + item.t + "<\/h3><\/div><\/div><\/a><\/li>",
            i.append(u);
...
function renderDetail(n) {
    ...
    t += '<button id="btn-action" class="btn-blue-small form-control btn-ads" type="button" onclick="convertFile(0)">Get link<\/button>') : t += '<div class="error"><p>The live video cannot be processed. Please try again later.<\/p><\/div>';
    t += '<span id="mesg-convert" class="form-control mesg-convert hidden"> <span class="lds-dual-ring"><\/span> ' + txt_processing + '<\/span><a id="asuccess" class="form-control mesg-convert success hidden" rel="nofollow" href="#"> ' + txt_download + ' <\/a> &nbsp &nbsp<a id="cnext" class="form-control mesg-convert hidden" href="' + k_url_next + '">' + txt_convert_next + '<\/a><\/div><br/> <div class="addthis-detail"><div class="addthis_inline_share_toolbox"><\/div><\/div> <\/div><\/div><\/div><\/div>';
    $("#search-result").html(t);
...
function renderFacebook(n) {
    ...
    n.links != undefined && n.links != null) {
        ...
        u += "_audio.mp4"));
        t += r + "<\/select>";
        t += '<a id="asuccess" class="form-control mesg-convert success btn-fb mg-r-10" target="_blank" rel="nofollow" href="' + i + '" download="' + u + '" data-type="mp4">' + txt_download + '<\/a><a id="cnext" class="form-control mesg-convert btn-fb" target="_blank" href="' + n.urlHD + '">' + txt_download + " HD+<\/a>"
    }
...
$(document).ready(function() {
    var t = window.location.search.substring(1)
      , n = parse_query_string(t);
    n.q !== undefined && n.q !== null && ksearchvideo();
    $("#s_input").keypress(function(n) {
    ...
    $.getScript("/snapinsta/js/common.min.js?v=1")
});
jQuery.fn.extend({
    setMenu: function() {
        return this.each(function() {
